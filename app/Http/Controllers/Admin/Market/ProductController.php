...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request, ImageService $imageService)
    {
        ...
        {
            $imageService->setExclusiveDirectory('image' . DIRECTORY_SEPARATOR . 'prduct');
            $result = $imageService->createIndexAndSave($request->file('image'));
        }
        if($result === false){
            return redirect()->route('admin.market.product.index')->with('swal-success', 'اپلور عکس با مشکل مواجه شد.');
